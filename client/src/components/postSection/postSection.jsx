            ...
            <div className="flex mx-4 justify-between">
              <div className="flex">
                ...
                <div className="flex mx-4 md:my-1 mt-2 py-2">
                  <p className="text-slate-500 text-xs md:text-base px-0.5">{postData.createdBy.username}</p>
                  <span className="text-slate-500 mx-3 hidden font-bold md:block">.</span>
                  <p className="text-slate-500 text-xs md:text-base px-0.5">{postData.createdAt.substring(0, 10)}</p>
                </div>
              </div>
              <div className="mx-2">
