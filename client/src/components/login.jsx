    ...
    return (
      ...
      <div className="m-10 absolute">
        ...
        <div className="w-[400px] h-[450px] mx-[15%]">
          <form className="bg-white rounded-md flex-col px-8 py-10">
            <input className="w-[329px] h-[53px] top-[116px] bg-black rounded-md text-white font-Akshar text-2xl " />
            <input className="my-5 w-[329px] h-[53px] top-[196px] bg-black rounded-md text-white font-Akshar text-2xl " />
